...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://id-preview--50dc930c-9422-4311-b7c5-a70f8d3d5b8a.lovable.app/logo.svg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://id-preview--50dc930c-9422-4311-b7c5-a70f8d3d5b8a.lovable.app/logo.svg" },
    ],
    links: [
      {
        rel: "stylesheet",
