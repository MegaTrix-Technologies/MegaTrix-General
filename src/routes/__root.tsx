...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "/mt-logo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "/mt-logo.png" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "icon", type: "image/png", href: "/mt-logo.png" },
      { rel: "apple-touch-icon", href: "/mt-logo.png" },
